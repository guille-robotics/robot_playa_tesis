...
class OdometryPublisher(Node):
    ...
    def __init__(self):
        ...
        self.ser = serial.Serial('/dev/ttyACM0', 9600)  # Cambia tu puerto
        self.ser.flush()
...
while True:
            try:
                ...
                self.get_logger().info(
                    f"PosiciÃ³n X: {x:.2f} m, "
                    f"PosiciÃ³n Y: {y:.2f} m, "
                    f"OrientaciÃ³n Theta: {theta:.3f} rad, "
...
# Llenar el mensaje de odometria
                ...
                # AÃ±adir la orientacion al transformado
